...
// Sessionat brand colors - Orange palette (replacing Google Blue)
constexpr SkColor kGoogleBlue050 = SkColorSetRGB(0xFF, 0xED, 0xD5);  // #ffedd5
constexpr SkColor kGoogleBlue100 = SkColorSetRGB(0xFE, 0xD7, 0xAA);  // #fed7aa
constexpr SkColor kGoogleBlue200 = SkColorSetRGB(0xFD, 0xBA, 0x74);  // #fdba74
constexpr SkColor kGoogleBlue300 = SkColorSetRGB(0xFC, 0xA6, 0x58);  // #fca658
constexpr SkColor kGoogleBlue400 = SkColorSetRGB(0xFB, 0x92, 0x3C);  // #fb923c
constexpr SkColor kGoogleBlue500 = SkColorSetRGB(0xFA, 0x82, 0x28);  // #fa8228
constexpr SkColor kGoogleBlue600 = SkColorSetRGB(0xF9, 0x73, 0x16);  // #f97316 - Sessionat Primary
constexpr SkColor kGoogleBlue700 = SkColorSetRGB(0xEA, 0x58, 0x0C);  // #ea580c
constexpr SkColor kGoogleBlue800 = SkColorSetRGB(0xC2, 0x41, 0x0C);  // #c2410c
constexpr SkColor kGoogleBlue900 = SkColorSetRGB(0x9A, 0x34, 0x12);  // #9a3412
