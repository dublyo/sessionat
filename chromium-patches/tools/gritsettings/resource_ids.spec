...
# IMPORTANT: For update instructions, see README.md.
{
 ...
 "<(SHARED_INTERMEDIATE_DIR)/ash/webui/projector_app/resources/app/untrusted/resources.grd": {
  ...
  # Sessionat NTP (chrome://sessionat-newtab/) — Sessionat v2 fork.
  # Placed near end of spec to satisfy monotonically-increasing ID requirement.
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/sessionat_ntp/resources.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [11000],
  },
  # Sessionat Visit Analytics dashboard (chrome://sessionat-analytics/).
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/sessionat_analytics/resources.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [11020],
  },
  # Sessionat Workspaces manager (chrome://sessionat-workspaces/).
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/sessionat_workspaces/resources.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [11040],
  },
  # Sessionat Quick-Switch (chrome://sessionat-quickswitch/).
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/sessionat_quickswitch/resources.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [11060],
  },
  # Sessionat embedded MCP status page (chrome://sessionat-mcp/).
  "<(SHARED_INTERMEDIATE_DIR)/chrome/browser/resources/sessionat_mcp/resources.grd": {
    "META": {"sizes": {"includes": [10]}},
    "includes": [11080],
  },
