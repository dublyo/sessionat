...
// Sessionat v2 service factories.
...
// update_notification_service_factory removed in v2.0 — Sparkle 2 replaces it.
...
#endif
  // Sessionat v2 services.
  sessionat::McpServiceFactory::GetInstance();
  sessionat::SessionHistoryServiceFactory::GetInstance();
  // UpdateNotificationServiceFactory removed in v2.0 — Sparkle 2.
  sessionat::VisitAnalyticsServiceFactory::GetInstance();
  sessionat::WorkspaceServiceFactory::GetInstance();
#if !BUILDFLAG(IS_ANDROID)
