...
// TODO(b/502297163): Implement for Android.
  ...
  // Sessionat: WorkspaceService prefs for workspaces and active workspace ID.
  sessionat::WorkspaceService::RegisterProfilePrefs(registry);
  // Sessionat: VisitAnalyticsService prefs for the local-only visit log.
  sessionat::VisitAnalyticsService::RegisterProfilePrefs(registry);
  // Sessionat: McpService enabled toggle.
  sessionat::McpService::RegisterProfilePrefs(registry);
