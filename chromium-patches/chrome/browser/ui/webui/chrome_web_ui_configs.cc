...
void RegisterChromeWebUIConfigs() {
  ...
  map.AddWebUIConfig(std::make_unique<SessionatAnalyticsUIConfig>());
  map.AddWebUIConfig(std::make_unique<SessionatMcpUIConfig>());
  map.AddWebUIConfig(std::make_unique<SessionatNtpUIConfig>());
  map.AddWebUIConfig(std::make_unique<SessionatQuickSwitchUIConfig>());
  map.AddWebUIConfig(std::make_unique<SessionatWorkspacesUIConfig>());
