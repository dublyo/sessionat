...
void TabHelpers::AttachTabHelpers(WebContents* web_contents) {
  ...
  // Sessionat: local-only visit recorder. Listens for DidFinishNavigation
  // and forwards to VisitAnalyticsService. No network calls.
  sessionat::VisitAnalyticsTabHelper::CreateForWebContents(web_contents);
