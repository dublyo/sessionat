...
class TabStripModel {
 public:
  ...
  enum ContextMenuCommand {
    ...
    CommandGlicUnshare,
    // Sessionat: opens a submenu listing all workspaces (and "+ New Workspace")
    // so the user can save the right-clicked tab into one of them.
    CommandSessionatMoveToWorkspace,
    CommandLast
  };
