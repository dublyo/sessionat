...
bool TabStripModel::IsContextMenuCommandEnabled(
  ...
  switch (command_id) {
    ...
    case CommandSessionatMoveToWorkspace:
      // Submenu items handle their own execution; the parent item just needs
      // to be enabled so the submenu opens.
      return true;
...
void TabStripModel::ExecuteContextMenuCommand(int context_index,
  ...
  switch (command_id) {
    ...
    case CommandSessionatMoveToWorkspace: {
      // Do nothing. The WorkspaceSubMenuModel handles the actual workspace
      // item clicks via its own ExecuteCommand.
      break;
    }
