...
class BrowserView : public BrowserWindow,
 ...
 public:
  ...
  // Sessionat: helper that checks vertical-tabs eligibility without depending
  // on ShouldDrawTabStrip() (so we can suppress the horizontal strip when
  // vertical is enabled without creating a circular dependency).
  bool ShouldDrawVerticalTabStripInternal() const;
