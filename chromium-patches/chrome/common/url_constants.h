...
// The URL for the Sessionat project used in the About dialog.
// (Was https://www.chromium.org/ upstream — redirected to our own site.)
inline constexpr char16_t kChromiumProjectURL[] = u"https://sessionat.com/";
#if BUILDFLAG(IS_CHROMEOS)
