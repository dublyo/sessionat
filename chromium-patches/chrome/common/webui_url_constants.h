...
// Sessionat custom New Tab Page.
inline constexpr char kChromeUISessionatNtpHost[] = "sessionat-newtab";
inline constexpr char kChromeUISessionatNtpURL[] = "chrome://sessionat-newtab/";
// Sessionat Visit Analytics dashboard.
inline constexpr char kChromeUISessionatAnalyticsHost[] = "sessionat-analytics";
inline constexpr char kChromeUISessionatAnalyticsURL[] =
    "chrome://sessionat-analytics/";
// Sessionat Workspaces manager page.
inline constexpr char kChromeUISessionatWorkspacesHost[] =
    "sessionat-workspaces";
inline constexpr char kChromeUISessionatWorkspacesURL[] =
    "chrome://sessionat-workspaces/";
// Sessionat Quick-Switch (Cmd+K spotlight).
inline constexpr char kChromeUISessionatQuickSwitchHost[] =
    "sessionat-quickswitch";
inline constexpr char kChromeUISessionatQuickSwitchURL[] =
    "chrome://sessionat-quickswitch/";
// Sessionat embedded MCP server status page.
inline constexpr char kChromeUISessionatMcpHost[] = "sessionat-mcp";
inline constexpr char kChromeUISessionatMcpURL[] = "chrome://sessionat-mcp/";
