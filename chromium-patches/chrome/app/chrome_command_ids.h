...
// menus).
// Sessionat: "Add page to current workspace" — appears in the page context
// menu (right-click anywhere on a website). Adds the page URL+title to
// WorkspaceService::GetActiveWorkspace.
#define IDC_SESSIONAT_ADD_PAGE_TO_WORKSPACE                   54100
// Sessionat: Cmd+Shift+] / Cmd+Shift+[ cycle workspaces forward/backward.
// Replaces Chromium's IDC_SELECT_NEXT/PREVIOUS_TAB on those bindings; in a
// vertical-tabs layout, cross-workspace navigation is more valuable than
// cross-tab. Tabs remain reachable via Ctrl+Tab and Ctrl+PageDown/Up.
#define IDC_SESSIONAT_NEXT_WORKSPACE                          54101
#define IDC_SESSIONAT_PREV_WORKSPACE                          54102
// Cmd+Shift+M opens chrome://sessionat-workspaces/ as the move-tab picker
// (per spec §4.1.6). Overrides Chrome's IDC_SHOW_AVATAR_MENU which is
// not relevant for Sessionat's single-profile-by-default posture.
#define IDC_SESSIONAT_MOVE_TAB_TO_WORKSPACE                   54103
// Cmd+K opens the Sessionat spotlight-style quick switcher
// (chrome://sessionat-quickswitch/) as a centered popup window. Cmd+K is
// unused by upstream Chrome on Mac.
#define IDC_SESSIONAT_QUICK_SWITCH                            54104
